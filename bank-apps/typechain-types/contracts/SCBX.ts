...
export interface SCBXInterface extends utils.Interface {
  functions: {
    "batchTransfer(string[],string[],address[],uint256[])": FunctionFragment;
...
export interface SCBX extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SCBXInterface;
